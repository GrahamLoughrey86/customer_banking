...
def main():
    ...
    months = int(input("Enter the amount of months interest will be accrued: "))
    ...
    cd_maturity = int(input("Enter the amount of months interest will be accrued: "))
    # Call the create_cd_account function and pass the variables from the user.
    updated_cd_balance, interest_cd_earned = create_cd_account(cd_balance, cd_interest_rate, cd_maturity)

    # Print out the interest earned and updated CD account balance with interest earned for the given months.
    # ADD YOUR CODE HERE
    print(f"Interest earned on CD account: ${interest_cd_earned:.2f}")
